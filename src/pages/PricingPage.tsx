...
const PricingPage = () => {
  ...
  const price = pts;
  const bonus =
    pts >= 5000 ? Math.round(pts * 0.15)
    : pts >= 1000 ? Math.round(pts * 0.1)
      ...
      <section className="relative py-16">
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          <div className="text-center mb-12">
            <div className="text-[11px] tracking-[0.28em] uppercase mb-4" style={{ color: "hsl(var(--muted-foreground))" }}>
              Тарифы · Pay-as-you-go
            </div>
            <h1
              className="font-display tracking-tight leading-[0.95] mb-5"
          ...
          {/* ── Calculator ── */}
          <div
            className="rounded-[24px] p-10 mb-14"
            style={{ background: "hsl(var(--card))", border: "1px solid rgba(255,255,255,0.14)" }}
          >
            <div className="grid gap-10 items-start" style={{ gridTemplateColumns: "7fr 5fr" }}>
              ...
              <div>
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-[11px]" style={{ color: "rgba(250,250,250,0.42)" }}>двигайте слайдер</span>
                </div>

                {/* Mega number */}
                <div className="flex items-baseline gap-3 mb-2">
                  <span className="font-display tracking-tight" style={{ fontSize: 96, fontWeight: 400, lineHeight: 1 }}>
                ...
                <input
                  ...
                  className="w-full"
                  style={{ accentColor: "#b478fd", height: 4 }}
                />
                ...
                <div className="flex justify-between text-[10px] mt-2 font-mono" style={{ color: "rgba(250,250,250,0.42)" }}>
                  {[100, 500, 1000, 2500, 5000, 10000].map((v) => (
                    <button
                      ...
                      style={{ color: pts === v ? "hsl(var(--accent))" : "rgba(250,250,250,0.42)" }}
                    >
              ...
              {/* Right: breakdown */}
              <div>
                <div className="text-[11px] tracking-[0.28em] uppercase mb-4" style={{ color: "rgba(250,250,250,0.42)" }}>
                  Что получите
                </div>
                <div
                  ...
                  {breakdown.map((b, i) => (
                    <div
                      ...
                      style={{
                        ...
                        borderBottom: i < breakdown.length - 1 ? "1px solid hsl(var(--border))" : "none",
                      }}
                    >
                      ...
                      <div className="text-right">
                        <div className="font-display text-[24px]" style={{ color: "hsl(var(--accent))" }}>
                          {b.each.split(" ")[0]}
                        </div>
                        <div className="text-[10px]" style={{ color: "rgba(250,250,250,0.42)" }}>
                          {b.each.split(" ").slice(1).join(" ")}
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <Link
                  to="/signup"
                  className="block w-full mt-5 py-3 rounded-xl text-[14px] text-center transition-opacity hover:opacity-90"
          ...
          <div className="mb-14">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-[11px] tracking-[0.28em] uppercase" style={{ color: "hsl(var(--muted-foreground))" }}>
            ...
            <div className="rounded-[16px] overflow-hidden" style={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))" }}>
              {/* Header */}
              <div
                className="grid grid-cols-4 gap-4 px-6 py-3 text-[10px] uppercase tracking-widest"
                style={{ color: "rgba(250,250,250,0.42)", background: "rgba(255,255,255,0.02)", borderBottom: "1px solid hsl(var(--border))" }}
              >
                <span>Модель</span>
                <span>У вендора</span>
                <span>Цена у вендора</span>
                <span className="text-right">В Imagination</span>
              </div>
              {VENDOR_COMPARE.map((r) => (
                <div
                  key={r.model}
                  className="grid grid-cols-4 gap-4 px-6 py-4 items-center text-[13px]"
                ...
                >
                  ...
                  <span className="text-right font-mono" style={{ color: "hsl(var(--accent))" }}>
                    {r.ours} пт = {r.ours} ₽
                  </span>
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {USE_CASES.map((c) => (
              ...
              >
                ...
                <div className="font-mono text-[12px] mb-2" style={{ color: "hsl(var(--accent))" }}>
                  {c.points.toLocaleString("ru-RU")} пт · {c.points} ₽
                </div>
